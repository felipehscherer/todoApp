...
public class TaskDialogScreen extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabelTaskSave.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/check/check (4).png"))); // NOI18N
        ...
        jPanelToolBarLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelToolBarLayout.createSequentialGroup()
                ...
                .addComponent(jLabelTaskSave, javax.swing.GroupLayout.PREFERRED_SIZE, 49, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        jPanelToolBarLayout.setVerticalGroup(
            ...
            .addGroup(jPanelToolBarLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabelTaskSave, javax.swing.GroupLayout.DEFAULT_SIZE, 68, Short.MAX_VALUE))
            .addComponent(jLabelToolBarTitle, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
    ...
    private void jLabelTaskSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelTaskSaveMouseClicked
        ...
        try {
            if (!jTextFieldName.getText().isEmpty() || jFormattedTextFieldDeadline.getText().isEmpty()) {
                ...
                JOptionPane.showMessageDialog(rootPane, "Os campos Nome e Prazo são obrigatorios para salvar uma tarefa");
            }
