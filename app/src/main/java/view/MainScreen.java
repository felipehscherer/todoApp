...
import model.Task;
import util.ButtomColumnCellRederer;
...
public class MainScreen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPaneTasks.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        jLabelToolBarTitle.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/tick/tick (4).png"))); // NOI18N
        ...
        jPanelTasksLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelTasksLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabelTasksTitle, javax.swing.GroupLayout.PREFERRED_SIZE, 462, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabelEmptySubTitle.setForeground(new java.awt.Color(204, 204, 204));
        jLabelEmptySubTitle.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabelEmptySubTitle.setText("Clique no botão \"+\" para adicionar uma tarefa.");
        ...
        jLabelTitle.setText("Nenhuma tarefa encontrada ;D");
        ...
        jPanelEmptyListLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelEmptyListLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabelEmptySubTitle, javax.swing.GroupLayout.DEFAULT_SIZE, 498, Short.MAX_VALUE))
        );
    ...
    private void jLabelProjectsAddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelProjectsAddMouseClicked
        // Cria uma nova janela visivel
        ProjectDialogScreen projectDialogScreen = new ProjectDialogScreen(this, rootPaneCheckingEnabled);
        projectDialogScreen.setVisible(true);
        
        
        // sempre que a janela fechar ele vai carregar os projetos
        // add um ouvinte a partir do objeto e quando acontecer um evento de close vai carregar o método
    ...
    /**
    * método de marcar a tarefa concluida
    * recebe o @param evt descobre onde foi o evento 
    * se for igual a 3(box boolean) ele da o update ja no bd
    */
    private void jTableTasksMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableTasksMouseClicked
        int rowIndex = jTableTasks.rowAtPoint(evt.getPoint());//diz qual é a linha com base em um ponto
        int columnIndex = jTableTasks.columnAtPoint(evt.getPoint());// "" coluna
    ...
    public void decorateTableTask(){
        // Customização do header da tableTask
        ...
        jTableTasks.getColumnModel().getColumn(4).setCellRenderer(new ButtomColumnCellRederer("pencil (5)"));
        jTableTasks.getColumnModel().getColumn(5).setCellRenderer(new ButtomColumnCellRederer("close (5)"));
        
        // cria automaticamente uma sorter por coluna
    ...
    // carrega os dados do projeto com o DefaultListModel
    public void loadProjects(){
        // pega todos os projetos e guarda dentro da List
        List<Project> projects = projectController.getAll();
        
        // limpa o projectModel, caso tenha algum dado ele limpa
        projectsModel.clear();
